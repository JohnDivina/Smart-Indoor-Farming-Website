        ...
        if (!preg_match('/^\d{6}$/', $enteredOTP)) {
            ...
            if ($result->num_rows > 0) {
                ...
                if ($attempts >= 3) {
                    ...
                    error_log("Stored Hash: " . $otpHash);
                    error_log("Verify Result: " . (password_verify($enteredOTP, $otpHash) ? 'TRUE' : 'FALSE'));
                    
                    if (password_verify($enteredOTP, $otpHash)) {
                        // OTP is correct - Authenticate user
                        ...
                        // Update email_verified and last_login
                        ...
                        $_SESSION["email_verified"] = 1; // Now verified
                        ...
                        if ($remainingAttempts > 0) {
                            $error_message = "Invalid or expired verification code. $remainingAttempts attempt(s) remaining.";
                        } else {
                            $error_message = "Invalid or expired verification code. No attempts remaining.";
                        }
                    }
                }
            } else {
...
<head>
  <meta charset="UTF-8">
  <title>CLSU CRRDC | VERIFY OTP</title>
      ...
      <div class="col-md-6 right-panel">
        <div class="verify-box">
          ...
          <form method="POST" action="">
            ...
            <button type="submit" name="verify_otp" class="btn btn-verify">VERIFY CODE</button>
          </form>
