...
if (!isset($_SESSION['otp_user_id']) || !isset($_SESSION['otp_reason']) || $_SESSION['otp_reason'] !== 'password_reset') {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['verify_otp'])) {
        ...
        $otpResult = sendOTPEmail($userId, $resetEmail, $userName, $conn);
    ...
    <div class="row h-100">
      ...
      <div class="col-md-6 right-panel">
        <div class="verify-box">
          ...
          <div class="verify-title">Password Reset Verification</div>
          ...
          <div class="info-box">
            ...
            <p>We've sent a 6-digit code to <strong><?php echo htmlspecialchars($resetEmail); ?></strong></p>
          ...
          <div class="back-link mt-4">
            <a href="forgot_Password.php">← Back to Password Reset</a>
          </div>
        </div>
      </div>
    </div>
